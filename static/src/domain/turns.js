// Turn payload normalization: server-shape → frontend-shape conversion.
// visibleText is exported because ui/render-turn.js uses the same
// committed/preview merge rule to decide whether to render a row.
